...
\end{center}    
 ...
 \vspace{-0.3in}
		...
		\includegraphics[width=0.9\textwidth]{random_forest_feature_importance__100_shape_eigenvalues__and_100_thickness_modes_dia_sys.eps}
...
\label{fig:random_forest_feature_importance__100_shape_eigenvalues__and_100_thickness_modes_dia_sys}			\end{center}
	...
	\begin{center}
		...
		\includegraphics[width=1\textwidth]{classification_error__5kfold_LOO__all_72_dia_sys.eps}
...
\label{fig:classification_error__5kfold_LOO__all_72_dia_sys}			\end{center}
		...
		\subfigure[]
		{
		\includegraphics[width=0.9\textwidth, height = 0.5\textwidth]{random_forest_feature_importance__all_72__dia_sys.eps}
		}
...
{
\includegraphics[width=0.15\textwidth]{diastole_mode13_std-3.png} 
...
\includegraphics[width=0.15\textwidth]{systole_mean.png} \label{fig:systole_mean}
