...
%These metrics could help the development of novel %ways to quantify risk and patient-specific %treatment options.
...
\subfigure[]{
\includegraphics[width = 0.45\textwidth ]{Ejection_fraction_sensitivity_versus_specificity__leave_one_out.eps} \label{fig:sensitivity_versus_specificity_EF}}
