...
\subfigure[]{\includegraphics[width = 0.7\columnwidth]{Ejection_fraction_histograms.eps}
 \label{fig:Ejectionfractionhistograms}}

\!
\subfigure[]{\includegraphics[width = 0.7\columnwidth ]{sensitivity_versus_specificity_EF___leave_one_out.eps} \label{fig:sensitivity_versus_specificity_EF}}
...
\label{fig:random_forest_feature_importance__100_shape_eigenvalues__and_100_thickness_modes_dia_sys}			\end{center}
		...
		\includegraphics[width = 1\columnwidth]{random_forest_feature_importance__all_72_line_plot__dia_sys.eps}
...
\label{fig:random_forest_feature_importance__all_72__dia_sys}		\end{center}
	...
	\begin{center}
		...
		\includegraphics[width = 1\columnwidth]{classification_error__5kfold_LOO__all_72_dia_sys.eps}
...
{
\includegraphics[width=0.3\columnwidth]{diastole_mode13_std-3.png} 
...
\includegraphics[width=0.3\columnwidth]{systole_mean.png} 
